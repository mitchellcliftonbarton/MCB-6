...
const css = {
  code: ".grid-view.svelte-po8hvk li.svelte-po8hvk{border-bottom:1px solid var(--grey-3);border-right:1px solid var(--grey-3);display:flex;align-items:stretch}.grid-view.svelte-po8hvk li.svelte-po8hvk a{flex:1;width:100%}.grid-view.svelte-po8hvk li.svelte-po8hvk:nth-child(-n + 2){border-top:1px solid var(--grey-3)}.grid-view.svelte-po8hvk li.svelte-po8hvk:nth-child(-n + 6){@media screen and (min-width: 1024px) {\n			border-top: 1px solid var(--grey-3);\n		}}.grid-view.svelte-po8hvk li.svelte-po8hvk:nth-child(2n + 1){border-left:1px solid var(--grey-3)}.grid-view.svelte-po8hvk li.svelte-po8hvk:nth-child(6n + 1){@media screen and (min-width: 1024px) {\n			border-left: 1px solid var(--grey-3);\n		}}.list.svelte-po8hvk li{border-top:1px solid var(--grey-3)}.list.svelte-po8hvk li:last-child{border-bottom:1px solid var(--grey-3)}.content-container.svelte-po8hvk.svelte-po8hvk{transition:opacity 0.4s;pointer-events:auto}",
  map: `{"version":3,"file":"WipGrid.svelte","sources":["WipGrid.svelte"],"sourcesContent":["<script>\\n\\timport { goto } from '$app/navigation';\\n\\timport Pagination from '$lib/components/Pagination.svelte';\\n\\timport WipGridItem from '$lib/components/WipGridItem.svelte';\\n\\timport WipSearchButton from '$lib/components/WipSearchButton.svelte';\\n\\n\\t// props\\n\\texport let data,\\n\\t\\tterm,\\n\\t\\tbasePath = '/wip';\\n\\n\\t// data\\n\\tlet loading = false;\\n\\n\\t// make wip reactive\\n\\t$: wipItems = data.wip;\\n\\t$: paginationData = data.paginationData;\\n\\t$: totalCount = data.totalCount;\\n\\t$: range = data.range;\\n\\t$: searchTerm = term;\\n\\n\\t// handle pagination link clicked\\n\\tfunction handlePaginationLinkClicked(event) {\\n\\t\\tgoto(event.detail.href);\\n\\n\\t\\twipItems = event.detail.data.wip;\\n\\t\\tpaginationData = event.detail.data.paginationData;\\n\\t\\trange = event.detail.data.range;\\n\\t\\tloading = false;\\n\\t}\\n\\n\\tfunction handleSetLoading(event) {\\n\\t\\tloading = event.detail;\\n\\t}\\n<\/script>\\n\\n<div class=\\"mt-20 lg:mt-40 pb-40 lg:pb-60\\">\\n\\t<div class=\\"enter-in-1 text-center max-w-[250px] mx-auto\\">\\n\\t\\t<h1>WIP</h1>\\n\\t\\t{#if searchTerm}\\n\\t\\t\\t<p class=\\"mt-6\\">\\n\\t\\t\\t\\t{totalCount} results for: <span class=\\"bg-pink\\">“{searchTerm}”</span>\\n\\t\\t\\t</p>\\n\\t\\t{/if}\\n\\t</div>\\n\\n\\t<div class={\`content-container mt-8 lg:mt-48\`}>\\n\\t\\t<div class=\\"flex justify-between items-center\\">\\n\\t\\t\\t<WipSearchButton />\\n\\n\\t\\t\\t{#if loading === false}\\n\\t\\t\\t\\t<p class=\\"enter-in-1\\">{range.from} - {range.to} of {totalCount} items</p>\\n\\t\\t\\t{/if}\\n\\t\\t</div>\\n\\n\\t\\t{#if loading === false}\\n\\t\\t\\t<ul class=\\"enter-in-1 delay-100 grid-view grid grid-cols-2 lg:grid-cols-6 mt-4 lg:mt-6\\">\\n\\t\\t\\t\\t{#each wipItems as item}\\n\\t\\t\\t\\t\\t<li key={item._id}>\\n\\t\\t\\t\\t\\t\\t<WipGridItem {item} />\\n\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t{/each}\\n\\t\\t\\t</ul>\\n\\n\\t\\t\\t{#if paginationData.totalPages > 1}\\n\\t\\t\\t\\t<Pagination\\n\\t\\t\\t\\t\\t{paginationData}\\n\\t\\t\\t\\t\\t{basePath}\\n\\t\\t\\t\\t\\ton:pagination-link-clicked={handlePaginationLinkClicked}\\n\\t\\t\\t\\t\\ton:set-loading={handleSetLoading}\\n\\t\\t\\t\\t/>\\n\\t\\t\\t{/if}\\n\\t\\t{/if}\\n\\t</div>\\n</div>\\n\\n<style>\\n\\t/* add bottom and right border to all items */\\n\\t.grid-view li {\\n\\t\\tborder-bottom: 1px solid var(--grey-3);\\n\\t\\tborder-right: 1px solid var(--grey-3);\\n\\t\\tdisplay: flex;\\n\\t\\talign-items: stretch;\\n\\t}\\n\\n\\t.grid-view li :global(a) {\\n\\t\\tflex: 1;\\n\\t\\twidth: 100%;\\n\\t}\\n\\n\\t/* add top border to first 2 items on mobile only */\\n\\t.grid-view li:nth-child(-n + 2) {\\n\\t\\tborder-top: 1px solid var(--grey-3);\\n\\t}\\n\\n\\t/* add top border to first 6 items on desktop only */\\n\\t.grid-view li:nth-child(-n + 6) {\\n\\t\\t@media screen and (min-width: 1024px) {\\n\\t\\t\\tborder-top: 1px solid var(--grey-3);\\n\\t\\t}\\n\\t}\\n\\n\\t/* add left border to first item on each row for desktop. */\\n\\t.grid-view li:nth-child(2n + 1) {\\n\\t\\tborder-left: 1px solid var(--grey-3);\\n\\t}\\n\\n\\t/* add left border to first item on each row for desktop. */\\n\\t.grid-view li:nth-child(6n + 1) {\\n\\t\\t@media screen and (min-width: 1024px) {\\n\\t\\t\\tborder-left: 1px solid var(--grey-3);\\n\\t\\t}\\n\\t}\\n\\n\\t.list :global(li) {\\n\\t\\tborder-top: 1px solid var(--grey-3);\\n\\t}\\n\\n\\t.list :global(li:last-child) {\\n\\t\\tborder-bottom: 1px solid var(--grey-3);\\n\\t}\\n\\n\\t.content-container {\\n\\t\\ttransition: opacity 0.4s;\\n\\t\\tpointer-events: auto;\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AA8EC,wBAAU,CAAC,gBAAG,CACb,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,QAAQ,CAAC,CACtC,YAAY,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,QAAQ,CAAC,CACrC,OAAO,CAAE,IAAI,CACb,WAAW,CAAE,OACd,CAEA,wBAAU,CAAC,gBAAE,CAAS,CAAG,CACxB,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,IACR,CAGA,wBAAU,CAAC,gBAAE,WAAW,MAAM,CAAE,CAC/B,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,QAAQ,CACnC,CAGA,wBAAU,CAAC,gBAAE,WAAW,MAAM,CAAE,CAC/B,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC;AACxC,GAAG,YAAY,GAAG,CAAC,KAAK,CAAC,IAAI,QAAQ,CAAC;AACtC,GACC,CAGA,wBAAU,CAAC,gBAAE,WAAW,MAAM,CAAE,CAC/B,WAAW,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,QAAQ,CACpC,CAGA,wBAAU,CAAC,gBAAE,WAAW,MAAM,CAAE,CAC/B,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC;AACxC,GAAG,aAAa,GAAG,CAAC,KAAK,CAAC,IAAI,QAAQ,CAAC;AACvC,GACC,CAEA,mBAAK,CAAS,EAAI,CACjB,UAAU,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,QAAQ,CACnC,CAEA,mBAAK,CAAS,aAAe,CAC5B,aAAa,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,QAAQ,CACtC,CAEA,8CAAmB,CAClB,UAAU,CAAE,OAAO,CAAC,IAAI,CACxB,cAAc,CAAE,IACjB"}`
};
const WipGrid = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  range = data.range;
  searchTerm = term;
  return `<div class="mt-20 lg:mt-40 pb-40 lg:pb-60"><div class="enter-in-1 text-center max-w-[250px] mx-auto"><h1 data-svelte-h="svelte-1eeoqyu">WIP</h1> ${searchTerm ? `<p class="mt-6">${escape(totalCount)} results for: <span class="bg-pink">“${escape(searchTerm)}”</span></p>` : ``}</div> <div class="${escape(null_to_empty(`content-container mt-8 lg:mt-48`), true) + " svelte-po8hvk"}"><div class="flex justify-between items-center">${validate_component(WipSearchButton, "WipSearchButton").$$render($$result, {}, {}, {})} ${`<p class="enter-in-1">${escape(range.from)} - ${escape(range.to)} of ${escape(totalCount)} items</p>`}</div> ${`<ul class="enter-in-1 delay-100 grid-view grid grid-cols-2 lg:grid-cols-6 mt-4 lg:mt-6 svelte-po8hvk">${each(wipItems, (item) => {
    return `<li${add_attribute("key", item._id, 0)} class="svelte-po8hvk">${validate_component(WipGridItem, "WipGridItem").$$render($$result, { item }, {}, {})} </li>`;

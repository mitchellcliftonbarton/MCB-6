...
import { s as searchActive, i as isLargeQuery } from "../../chunks/globalStore.js";
const getStores = () => {
...
const WipDetailControls = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="wip-controls col-span-6 lg:col-span-4 flex gap-6 lg:gap-20 justify-end lg:justify-center enter-in-1 svelte-r8tvzq"><a${add_attribute(
    "href",
    `/wip/${wipDetail.previousItem ? wipDetail.previousItem.slug.current : wipDetail.lastItem.slug.current}`,
    0
  )}>${validate_component(LeftArrow, "LeftArrow").$$render($$result, {}, {}, {})}</a> <div class="hidden lg:block"><p>${escape(wipDetail.currentIndex)} of ${escape(wipDetail.totalCount)}</p></div> ${wipDetail.nextItem ? `<a${add_attribute(
    "href",
    `/wip/${wipDetail.nextItem ? wipDetail.nextItem.slug.current : wipDetail.firstItem.slug.current}`,
    0
  )}>${validate_component(RightArrow, "RightArrow").$$render($$result, {}, {}, {})}</a>` : ``} </div>`;
});
const css$3 = {
  code: "header.svelte-neqrk1.svelte-neqrk1{position:fixed;top:0px;left:0px;width:100%;height:var(--nav-height-mobile);z-index:500;@media screen and (min-width: 1024px) {\n			height: var(--nav-height);\n		}}header.svelte-neqrk1 nav li span.svelte-neqrk1{margin-left:-0.3em}header.svelte-neqrk1 nav li.svelte-neqrk1:not(:first-child){margin-left:0.3em}header.svelte-neqrk1 ul li.svelte-neqrk1 a.active{color:var(--primary)}header.svelte-neqrk1 .nav-options-dropdown{display:none;@media screen and (min-width: 1024px) {\n			display: flex;\n		}}",
  map: `{"version":3,"file":"MainNav.svelte","sources":["MainNav.svelte"],"sourcesContent":["<script>\\n\\timport { page } from '$app/stores';\\n\\timport MainNavLink from './MainNavLink.svelte';\\n\\timport WipDetailControls from './WipDetailControls.svelte';\\n\\timport NavOptionsDropdown from './NavOptionsDropdown.svelte';\\n\\n\\t// define nav links\\n\\tconst navLinks = [\\n\\t\\t{\\n\\t\\t\\tname: 'Info/CV',\\n\\t\\t\\tpath: '/info'\\n\\t\\t},\\n\\t\\t{\\n\\t\\t\\tname: 'WIP',\\n\\t\\t\\tpath: '/wip'\\n\\t\\t}\\n\\t];\\n\\n\\t// get wip data\\n\\t$: wipDetail = $page.data?.wipDetail;\\n<\/script>\\n\\n<header\\n\\tclass=\\"w-full px-4 lg:px-base-1/2 py-4 lg:py-base-1/2 grid grid-cols-12 gap-2 lg:gap-base-1/2 items-center\\"\\n>\\n\\t<div class=\\"flex items-center col-span-6 lg:col-span-4\\">\\n\\t\\t<nav class=\\"h-full flex items-center\\">\\n\\t\\t\\t<ul>\\n\\t\\t\\t\\t<div>\\n\\t\\t\\t\\t\\t<li>\\n\\t\\t\\t\\t\\t\\t<MainNavLink link={{ name: 'Mitchell Barton', path: '/' }} />\\n\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t<div class=\\"flex items-center\\">\\n\\t\\t\\t\\t\\t{#each navLinks as link, index}\\n\\t\\t\\t\\t\\t\\t<li>\\n\\t\\t\\t\\t\\t\\t\\t<MainNavLink {link} />\\n\\t\\t\\t\\t\\t\\t\\t{#if index !== navLinks.length - 1}\\n\\t\\t\\t\\t\\t\\t\\t\\t<span>,</span>\\n\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t</li>\\n\\t\\t\\t\\t\\t{/each}\\n\\t\\t\\t\\t</div>\\n\\t\\t\\t</ul>\\n\\t\\t</nav>\\n\\t</div>\\n\\n\\t{#if wipDetail}\\n\\t\\t<WipDetailControls {wipDetail} />\\n\\n\\t\\t<NavOptionsDropdown {wipDetail} />\\n\\t{/if}\\n</header>\\n\\n<style lang=\\"postcss\\">\\n\\theader {\\n\\t\\tposition: fixed;\\n\\t\\ttop: 0px;\\n\\t\\tleft: 0px;\\n\\t\\twidth: 100%;\\n\\t\\theight: var(--nav-height-mobile);\\n\\t\\tz-index: 500;\\n\\n\\t\\t@media screen and (min-width: 1024px) {\\n\\t\\t\\theight: var(--nav-height);\\n\\t\\t}\\n\\t}\\n\\n\\theader nav li span {\\n\\t\\tmargin-left: -0.3em;\\n\\t}\\n\\n\\theader nav li:not(:first-child) {\\n\\t\\tmargin-left: 0.3em;\\n\\t}\\n\\n\\theader ul li :global(a.active) {\\n\\t\\tcolor: var(--primary);\\n\\t}\\n\\n\\theader :global(.nav-options-dropdown) {\\n\\t\\tdisplay: none;\\n\\n\\t\\t@media screen and (min-width: 1024px) {\\n\\t\\t\\tdisplay: flex;\\n\\t\\t}\\n\\t}\\n</style>\\n"],"names":[],"mappings":"AAuDC,kCAAO,CACN,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,GAAG,CACR,IAAI,CAAE,GAAG,CACT,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,mBAAmB,CAAC,CAChC,OAAO,CAAE,GAAG,CAEZ,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC;AACxC,GAAG,QAAQ,IAAI,YAAY,CAAC;AAC5B,GACC,CAEA,oBAAM,CAAC,GAAG,CAAC,EAAE,CAAC,kBAAK,CAClB,WAAW,CAAE,MACd,CAEA,oBAAM,CAAC,GAAG,CAAC,gBAAE,KAAK,YAAY,CAAE,CAC/B,WAAW,CAAE,KACd,CAEA,oBAAM,CAAC,EAAE,CAAC,gBAAE,CAAS,QAAU,CAC9B,KAAK,CAAE,IAAI,SAAS,CACrB,CAEA,oBAAM,CAAS,qBAAuB,CACrC,OAAO,CAAE,IAAI,CAEb,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,MAAM,CAAC,CAAC;AACxC,GAAG,SAAS,IAAI;AAChB,GACC"}`
};
const MainNav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  wipDetail = $page.data?.wipDetail;
  $$unsubscribe_page();
  return `<header class="w-full px-4 lg:px-base-1/2 py-4 lg:py-base-1/2 grid grid-cols-12 gap-2 lg:gap-base-1/2 items-center svelte-neqrk1"><div class="flex items-center col-span-6 lg:col-span-4"><nav class="h-full flex items-center"><ul><div><li class="svelte-neqrk1">${validate_component(MainNavLink, "MainNavLink").$$render(
    $$result,
    {
    ...
    return `<li class="svelte-neqrk1">${validate_component(MainNavLink, "MainNavLink").$$render($$result, { link }, {}, {})} ${index !== navLinks.length - 1 ? `<span class="svelte-neqrk1" data-svelte-h="svelte-a4u4fq">,</span>` : ``} </li>`;
  })}</div></ul></nav></div> ${wipDetail ? `${validate_component(WipDetailControls, "WipDetailControls").$$render($$result, { wipDetail }, {}, {})} ${validate_component(NavOptionsDropdown, "NavOptionsDropdown").$$render($$result, { wipDetail }, {}, {})}` : ``} </header>`;
});
const css$2 = {
